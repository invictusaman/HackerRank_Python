...
The score of the word hacker is  because it contains an even number of vowels, i.e.  vowels, and the score of book is  for the same reason. Thus the total score is .
...
Full question - https://www.hackerrank.com/challenges/words-score/problem
'''
def is_vowel(letter):
